...
namespace ToolbAR.SceneManagement
{
    ...
    public class Scene
    {
        ...
        /// KNOWN ISSUE: If using asynchronous loading, this will be fired at the same late time as MonoBehaviour.OnLevelWasLoaded. No way to fix that ATM
        /// </summary>
        ...
        {
            SceneManager.Instance.changeSceneAsync(this);
        }
